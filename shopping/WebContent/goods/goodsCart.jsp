...
<script>
	...
	function prodChk(){
		var prodTot = 0;
		var chk = document.getElementsByName("prodCk");//check를 배열처리
		var hddchk = document.getElementsByName("cartPrice");//히든값을 불러와서 더하기
		var cnt = 0;
...
<tr>
	...
	<td colspan="2" align="right"><span id="prodCnt">${cnt }</span>개의 상품이 선택 되었습니다.<br />
총금액 : <span id="totalPrice">${price }</span>원</td></tr>
